...
const ALL_PAGES = ["/index.html", "/products/index.html", "/products/tools.html", "/products/safety-pins.html", "/products/jet-lighter.html", "/privacy.html", "/404.html"];
...
console.log("\n[ index.html ]");
{
  ...
  assert((await page.$$eval("#catGrid .cat", (e) => e.length)) === 3, "แสดงหมวดหมู่ครบ 3");
  assert((await page.$$eval("#featGrid .prod", (e) => e.length)) === 2, "แสดงสินค้าเด่น 2 การ์ด (ไฟฟู่ + WYNNTOOLS)");
...
console.log("\n[ products/index.html ]");
{
  ...
  await page.waitForTimeout(200);
  assert((await page.$$eval("#pgrid .prod", (e) => e.length)) === 2, "แสดงสินค้าทั้งหมด 2 (ก่อนกรอง)");
